...
| UI State Classes | `PascalCase + ScreenState` | `HomeScreenState` |
| Koin Modules | `camelCase + Module` | `homeFeatureModule` |
| Mappers | `PascalCase + Mapper` | `ProductMapper` |
| Repository Interfaces | `I + PascalCase + Repository` | `IProductRepository` |
| Repository Implementations | `PascalCase + Repository` | `ProductRepository` |
| UseCase Interfaces | `PascalCase + UseCase` | `GetProductsUseCase` |
| UseCase Interactors (Impl) | `PascalCase + Interactor` | `GetProductsInteractor` |
